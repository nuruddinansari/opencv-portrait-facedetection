    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if (mScale != 0) {
                    int canHeightMul = ((canvas.getHeight() - mCacheBitmap.getHeight()) / 2 + mCacheBitmap.getHeight());
                    int ratioMultipler = canvas.getHeight() - canHeightMul;

                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                            new Rect(0,
                                    0,
                                    ((canvas.getWidth() - mCacheBitmap.getWidth()) / 2 + mCacheBitmap.getWidth()) + ratioMultipler,
                                    canHeightMul + ratioMultipler), null);
                } else {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
